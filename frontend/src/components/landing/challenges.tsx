          ...
          <div className="p-6">
            <div className="relative overflow-hidden rounded-lg">
              ...
              <div className="absolute inset-0 bg-opacity-50 flex flex-col justify-end p-4 text-white">
                ...
                <p className="text-gray-200 text-xs">Solve complex algorithmic problems and optimize your solutions.</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            <div className="relative overflow-hidden rounded-lg">
              ...
              <div className="absolute inset-0 bg-opacity-50 flex flex-col justify-end p-4 text-white">
                ...
                <p className="text-gray-200 text-xs">Analyze datasets and create meaningful insights from data.</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
            <div className="relative overflow-hidden rounded-lg">
              ...
              <div className="absolute inset-0 bg-opacity-50 flex flex-col justify-end p-4 text-white">
                ...
                <p className="text-gray-200 text-xs">Create native and cross-platform mobile applications.</p>
              </div>
            </div>
          </div>
        </div>
